...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject helpSign, helpSign2, helpSign3;
    ...
    public GameObject successSoundHolder;
    ...
    void DisplayPattern()
    {
        ...
        {
            //Show sign for the user to pay attention to orbs
            helpSign.SetActive(true);
            helpSign2.SetActive(false);
    ...
    public void PuzzleSuccess()
    {
        ...
        successSoundHolder.GetComponent<GvrAudioSource>().Play();
        helpSign2.SetActive(false);
        helpSign3.SetActive(true);
